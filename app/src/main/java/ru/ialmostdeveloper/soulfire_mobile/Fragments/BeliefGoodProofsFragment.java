 ...
 * Use the {@link BeliefGoodProofsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BeliefGoodProofsFragment extends Fragment {
    ...
    public BeliefGoodProofsFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static BeliefGoodProofsFragment newInstance(String beliefId, String beliefTitle, String beliefContent, ArrayList<String> goodBeliefs) {
        BeliefGoodProofsFragment fragment = new BeliefGoodProofsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_addproof.setOnClickListener(v -> {
            ...
            SelfBeliefProof proof = new SelfBeliefProof(sessionManager.fetchUserId(), beliefId, "Good", proof_content, "");
